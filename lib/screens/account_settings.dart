      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('This is where you can control your\nlogin settings', style: Theme.of(context).textTheme.headline1!.copyWith(fontSize: 18, color: Colors.black),),
          ...
          const SizedBox(height: 30,),
            ...
            Center(
              child: SizedBox(
                  height: 52,
                  width: 317,
                  child: AppButton(onPressed: (){}, btnText: 'Delete Account', btnBackgroundColor: const Color(0xffF90733), btnTextColor: Colors.white)),
            )
          ],
        ),
      ),
