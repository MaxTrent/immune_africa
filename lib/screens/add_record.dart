                                  ...
                                  Padding(
                                    ...
                                    child: Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          GestureDetector(child: Icon(Icons.male, size: 60, color: context.watch<AddRecordProvider>().selectedGender == 1 ? primaryAppColor : Colors.black,), onTap: (){
                                            context.watch<AddRecordProvider>().selectMale();
                                          },),
                                          Align(
                                            alignment: Alignment.bottomCenter,
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color: Color(0xffB66EE8).withOpacity(0.6),
                                              ),
                                            ),
                                          ),
                                          GestureDetector(child: Icon(Icons.female, size: 60,), onTap: (){},),
                                        ],
                                      ),
                                    ),
                                  )
