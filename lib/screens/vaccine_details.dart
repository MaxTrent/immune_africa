        ...
        child: Column(
          ...
          Row(
            ...
            Row(
              ...
              children: [
                TextButton(onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (context)=> const AddVaccines()));  },
                child: Text('Add Vaccines',style: Theme.of(context).textTheme.headline1!.copyWith(color: const Color(0xff9F28F3), fontSize: 18),)),
           ...
           Container(
              ...
              child: TabBar(
                ...
                labelStyle: Theme.of(context).textTheme.headline1!.copyWith(fontSize: 18),
                labelColor: Colors.black,
                unselectedLabelColor: Color(0xff3E3E3E80),
                tabs: const [
                  Tab(
                    text: 'Vaccines',
                  ),
                   ...
                   itemBuilder: (BuildContext context, int index) {
                     return  Padding(
                       ...
                       child: ListTile(
                         ...
                         leading: SvgPicture.asset('assets/syringe_purple.svg'),
                         title: Text('Hepatitis  B'),
                         trailing: const Icon(Icons.arrow_forward_ios, color: primaryAppColor,),
                       ),
                     );
                   },
                 ),
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return  Padding(
                        ...
                        child: ListTile(
                          ...
                          leading: SvgPicture.asset('assets/syringe_green.svg'),
                          title: Text('Oral Polio Vaccine'),
                          subtitle: Text('Date Received: 14th July 2023'),
                        ),
                      );
                    },
                  ),
