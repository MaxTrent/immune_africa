          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder(
                  future: Provider.of<DashBoardProvider>(context, listen: false).retrieveRecords(),
                    builder: (BuildContext context, snapshot) {
                      ...
                      // }
                          ...
                          ConnectionState.done && context.watch<DashBoardProvider>().retrievedRecordsList == null) {
                        return Column(
                          children: [
                            Text(
                              'Nothing to show yet',
